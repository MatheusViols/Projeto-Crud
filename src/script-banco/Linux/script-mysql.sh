...
ADD CONSTRAINT fk_CNPJ_curso FOREIGN KEY (CNPJ) REFERENCES instituicao(CNPJ) ON UPDATE CASCADE ON DELETE CASCADE,
...
ADD CONSTRAINT fk_CNPJ_vaga FOREIGN KEY (CNPJ) REFERENCES empresa(CNPJ) ON UPDATE CASCADE ON DELETE CASCADE,
ADD CONSTRAINT fk_bairro_vaga FOREIGN KEY (cod_bairro) REFERENCES empresa(cod_bairro) ON UPDATE CASCADE;

ALTER TABLE matricula
ADD CONSTRAINT fk_CPF_mat FOREIGN KEY (CPF) REFERENCES usuario(CPF) ON UPDATE CASCADE ON DELETE CASCADE,
ADD CONSTRAINT fk_curso_mat FOREIGN KEY (cod_curso)  REFERENCES curso(cod_curso) ON UPDATE CASCADE ON DELETE CASCADE,
ADD CONSTRAINT pk_matricula PRIMARY KEY (CPF, cod_curso);

ALTER TABLE aplica
ADD CONSTRAINT fk_CPF_apli FOREIGN KEY (CPF) REFERENCES usuario(CPF) ON UPDATE CASCADE ON DELETE CASCADE,
ADD CONSTRAINT fk_vaga_apli FOREIGN KEY (cod_vaga) REFERENCES vaga(cod_vaga) ON UPDATE CASCADE ON DELETE CASCADE,
